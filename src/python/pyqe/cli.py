...
def parse_arguments():
    ...
    upload_parser.add_argument('--csv', action='store_true', help='Exports to csv files instead of SQL DB')
    upload_parser.add_argument('--excel', action='store_true', help='Exports to single Excel file instead of SQL DB')

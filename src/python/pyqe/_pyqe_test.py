...
class TestPyqe(unittest.TestCase):
    def setUp(self):
        ...
        self.cupcake_workflowresult = {}
        self.cupcake_workflowresult["step-1"] = {
            "class": "bake-cupcakes",
            "id": 0,
            "cupcakes": {
                "schema": "cupcakes",
                "cupcakes": [{"flavor": "chocolate"}, {"flavor": "vanilla"}],
            },
        }
        self.cupcake_workflowresult["step-2"] = {
            "class": "eat-cupcakes",
            "id": 1,
            "inputArtifact:cupcakes": "step-1/cupcakes",
            "score": {"schema": "scores", "scores": [10, 7]},
        }
    ...
    def test_build_workflow_tree(self):
        result = build_workflow_tree(self.cupcake_workflowresult, "eat-cupcakes")
